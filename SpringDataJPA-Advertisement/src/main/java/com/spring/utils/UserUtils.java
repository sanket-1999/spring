...
public class UserUtils {
	...
	public static User convertUserEntityToUser(UserEntity userEntity) {
		return new User(userEntity.getId(), userEntity.getUserName(), 
				userEntity.getFirstName(), userEntity.getLastName(),userEntity.getPassword(),userEntity.getEmail(),(int) userEntity.getPhone());
	}

	public static UserEntity convertUserToUserEntity(User user) {
		return new UserEntity(user.getId(), user.getUserName(), 
				user.getFirstName(), user.getLastName(),user.getPassword(),user.getEmail(),(int) user.getPhone());
	}
}
